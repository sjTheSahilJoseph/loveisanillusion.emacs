...
(let (
		 ...
		 (modline_active_foreground "#1c1c1c")
		 (modline_active_background "#bcbcbc")
		 (modline_inactive_foreground "#1c1c1c")
		 (modline_inactive_background "#bcbcbc")
		 (isearch_foreground "#cccccc")
		 (isearch_background "#1c1c1c")
		 (line_numbers_foreground "#555555")
		 (active_line_number_foreground "#aaaaaa")
		 (hl_line_background "#aaaaaa")
		 (dired_directory_background "#ff9900")
	...
	(custom-theme-set-faces
		...
		`(font-lock-preprocessor-face ((t (:foreground ,keyword_foreground))))
		...
		`(mode-line ((t (:foreground ,modline_inactive_foreground :background ,modline_active_background))))
