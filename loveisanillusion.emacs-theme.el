...
(let (
         ...
         ;;		 (main_modeline_foreground_colo r"#999999")
	     ...
	     (main_keyword_color "#cccccc")
         (main_strings_color "#cccccc")
	     (main_comment_color "#007a00")
	     (main_preprocessor_color "#cccccc")
	     (main_background_color "#0c0c0c")
	     (main_highlight_color "#1a0000")
	     (main_modeline_foreground_color "#0c0c0c")
	     (main_modeline_background_color "#cccccc")
	     (main_modeline_inactive_foreground_color "#cccccc")
	     (main_modeline_inactive_background_color "#0c0c0c")
	     (main_iSearch_color "#003a3a")
	     (pure_black_color "#000000")
	     (pure_white_color "#ffffff")
	     (pure_red_color "#ff0000")
         ...
         ;;	     (secondary_foreground_color "#000000")
         ;;	     (main_keyword_color "#000000")
         ;;	     (main_strings_color "#000000")
         ;;	     (main_comment_color "#007a00")
         ;;	     (main_preprocessor_color "#000000")
         ;;	     (main_background_color "#ffffff")
         ;;	     (main_highlight_color "#0078d7")
         ;;	     (main_modeline_foreground_color "#ffffff")
         ;;	     (main_modeline_background_color "#000000")
         ;;	     (main_modeline_inactive_foreground_color "#000000")
         ;;	     (main_modeline_inactive_background_color "#ffffff")
         ;;	     (main_iSearch_color "#0078d7")
         ;;	     (pure_black_color "#000000")
         ;;	     (pure_white_color "#ffffff")
         ;;	     (pure_red_color "#ff0000")
         ;;	     (main_hl_line_background_color "#003300")
